...
class GUI:
    ...
    def layout(self,name):
            ...
            self.textCons.place(relwidth=1,rely=.08)
            ...
            self.entryMsg.place(relwidth=.74,relheight=.05,relx=.011,rely=.008)
            self.entryMsg.focus()
            ...
            self.buttonMsg.place(relx=.77,rely=.008,relheight=.06,relwidth=.22)
